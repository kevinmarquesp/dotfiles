...
(gtk_accel_path "<Actions>/terminal-window/move-tab-right" "<Alt>Right")
(gtk_accel_path "<Actions>/terminal-window/move-tab-left" "<Alt>Left")
(gtk_accel_path "<Actions>/terminal-window/prev-tab" "<Alt><Shift>Tab")
(gtk_accel_path "<Actions>/terminal-window/next-tab" "<Alt>Tab")

(gtk_accel_path "<Actions>/terminal-window/close-tab" "<Alt>q")
(gtk_accel_path "<Actions>/terminal-window/new-tab" "<Alt>n")

(gtk_accel_path "<Actions>/terminal-window/preferences" "<Alt>c")
(gtk_accel_path "<Actions>/terminal-window/new-window" "<Alt><Shift>w")
