...
local plugins = {
    { "Nvchad/extensions" },        -- Utilidades do NvChad (tipo trocar de tema, etc)
    { "nvim-lua/plenary.nvim" },    -- Melhorias para a linguagem dentro do Neovim
    { "lewis6991/impatient.nvim" }, -- Torna a inicialização mais rápida
    { "nathom/filetype.nvim" },     -- Cria comandos (`au`) dependendo do tipo do arquivo
