...
alias la="ls -lhX -AogG --color=auto"
alias ls="ls -lhX -1 --color=auto"


# BASH PROMPT FROM CorruptComputer/.bashrc ~~~~~~~~~~~~~~~~~
...
bash_prompt() {
	...
	local BACKGROUND_1=$BLUE #Cor do fundo do usuário.
	local TEXTEFFECT_1=$BOLD
	
	local FONT_COLOR_2=$WHITE
	local BACKGROUND_2=$CYAN #Cor do fundo do nome.
